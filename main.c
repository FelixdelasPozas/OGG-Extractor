/*------------------------------------------------------------------------
 ...
 Project:       Generic OGG Ripper
 Version:       v1.4a
 Creation Date: February 27 2004
 Description:   Extracts Ogg files from game datafiles. Main file.
...
/* NOTE
** Mingw uses %I64d and %I64u to print 64 bits integers in signed and
** unsigned format, with other compilers you should probably change it
** to %lld and %llu equivalents.
**
** Mingw32, Digital Mars and Microsoft compilers will compile this code
** without changes. 
*/
